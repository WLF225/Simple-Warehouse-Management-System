...
public class AddProductMenu extends BorderPane {

    public AddProductMenu(Scene scene, ProductCategory productCategory) {

        Main.stage.setTitle("Add Product");

        setPadding(new javafx.geometry.Insets(100,300,100,300));

        TextField[] textFields = {new TextField(),new TextField(),new TextField()};

        Button[] buttons = {new Button("Add Product"), new Button("Clear"),new Button("Back")};
        ...
        buttons[0].setOnAction(e -> {
            try {
                ...
                ProductManagement.addProduct(new Product(textFields[0].getText(),textFields[1].getText(),textFields[2].getText(),status));
                buttons[1].fire();
        ...
        buttons[1].setOnAction(e -> {textFields[0].setText("P"+ ProductManagement.productID);
            textFields[1].setText("");textFields[2].setText(productCategory.getCategoryName());
            radioButtons[0].fire();
        });
